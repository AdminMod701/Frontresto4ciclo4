...
const TableOrder = () => {
    ...
    const getOrders = () => {
        ...
        axios.get('http://140.238.191.252:8080/api/order/zona/'+user.zone)
        .then(response => {
            let order = '';
    ...
    var seeDetail = () => {
        ...
        if(id == "") {
            ...
            axios.get('http://140.238.191.252:8080/api/order/'+id)
            .then(response =>{
                let mostrar = "";
    ...
    var editStatus = () =>{
        ...
        if(input == ""){
            ...
            if(updateState){
                axios.get('http://140.238.191.252:8080/api/order/'+updateState)
                .then(response =>{
                    response.data.status = input;
                    axios.put('http://140.238.191.252:8080/api/order/update', response.data)
                        .then(response =>{
